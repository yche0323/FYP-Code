...
def cnnlstma(dataframe, target_col, neuron1=2048, neuron2=1024, batch_size=32, dropout_rate=0.15):
    ...
    cnnlstma_roc_auc = roc_auc_score(y_test_one_hot, cnnlstma_predictions, average="macro", multi_class="ovr")
    ...
    return cnnlstma_loss, cnnlstma_roc_auc, tp_per_class, fp_per_class, tn_per_class, fn_per_class, model
